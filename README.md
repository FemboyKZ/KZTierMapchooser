...
To run this you also need the [SteamWorks](https://github.com/KyleSanderson/SteamWorks) and [SMJansson](https://github.com/davenonymous/SMJansson) extensions

## Dependencies

This plugin uses:

- [SourceMod](https://github.com/alliedmodders/sourcemod) 1.10.0-1.13.0
- [SteamWorks](https://github.com/KyleSanderson/SteamWorks) (edited in include/, to use the latest SourcePawn declaration style)
- [SMJansson](https://github.com/davenonymous/SMJansson) (edited in include/, to use the latest SourcePawn declaration style)
- KZTimerGlobal.com's maps API

## Build instructions on Windows (for any server OS)

- Download the latest [SourceMod for Windows](https://www.sourcemod.net/downloads.php?branch=stable)
- Copy the current [repo](https://github.com/Kidev/KZTierMapchooser/archive/refs/heads/master.zip) inside `sourcemod-xxxx-windows/addons/sourcemod/scripting/`
